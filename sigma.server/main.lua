...
local acscode = Instance.new("TextBox")
local placeidd = Instance.new("TextBox")
...
local hmac = {}
local base64 = {}
local queueontp = false

sigma.Name = genrandstr(35)
sigma.Parent = game:GetService("CoreGui")
sigma.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

main.Name = genrandstr(35)
main.Parent = sigma
main.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
main.BorderColor3 = Color3.fromRGB(0, 0, 0)
main.BorderSizePixel = 0
main.Position = UDim2.new(0.276416391, 0, 0.269471467, 0)
main.Size = UDim2.new(0, 240, 0, 110)

eshed.Name = genrandstr(35)
eshed.Parent = main
eshed.BackgroundColor3 = Color3.fromRGB(24, 24, 24)
eshed.BorderColor3 = Color3.fromRGB(0, 0, 0)
eshed.BorderSizePixel = 0
eshed.Size = UDim2.new(0, 240, 0, 20)

title.Name = genrandstr(35)
title.Parent = eshed
...
title.Text = "Sigma.Server"
title.TextColor3 = Color3.fromRGB(255, 255, 255)
title.TextSize = 12.000

close.Name = genrandstr(35)
close.Parent = main
close.BackgroundColor3 = Color3.fromRGB(24, 24, 24)
close.BackgroundTransparency = 1.000
close.BorderColor3 = Color3.fromRGB(0, 0, 0)
close.BorderSizePixel = 0
close.Position = UDim2.new(0.914462507, 0, 0, 0)
...
join.Name = genrandstr(35)
join.Parent = main
join.BackgroundColor3 = Color3.fromRGB(24, 24, 24)
join.BorderColor3 = Color3.fromRGB(0, 0, 0)
join.BorderSizePixel = 0
join.Position = UDim2.new(0.0346791595, 0, 0.665565372, 0)
join.Size = UDim2.new(0, 224, 0, 16)
join.Font = Enum.Font.SourceSans
join.Text = "Join"
join.TextColor3 = Color3.fromRGB(255, 255, 255)
join.TextSize = 12.000

acscode.Name = genrandstr(35)
acscode.Parent = main
acscode.BackgroundColor3 = Color3.fromRGB(24, 24, 24)
acscode.BorderColor3 = Color3.fromRGB(0, 0, 0)
acscode.BorderSizePixel = 0
acscode.Position = UDim2.new(0.0365468338, 0, 0.224981129, 0)
acscode.Size = UDim2.new(0, 223, 0, 16)
acscode.ClearTextOnFocus = false
acscode.Font = Enum.Font.SourceSans
acscode.PlaceholderColor3 = Color3.fromRGB(223, 223, 223)
acscode.PlaceholderText = "Server code"
acscode.Text = ""
acscode.TextColor3 = Color3.fromRGB(255, 255, 255)
acscode.TextSize = 14.000
acscode.TextWrapped = true

warn.Name = genrandstr(35)
warn.Parent = main
...
warn.Position = UDim2.new(0.0344902053, 0, 0.877049088, 0)
warn.Size = UDim2.new(0, 224, 0, 6)
warn.Font = Enum.Font.SourceSans
warn.Text = "WARNING! IF YOU DONT HAVE THIS SCRIPT YOU CANT JOIN!!!!!!!!"
warn.TextColor3 = Color3.fromRGB(126, 126, 126)
warn.TextSize = 10.000
warn.TextTransparency = 0.200

placeidd.Name = genrandstr(35)
placeidd.Parent = main
placeidd.BackgroundColor3 = Color3.fromRGB(24, 24, 24)
placeidd.BorderColor3 = Color3.fromRGB(0, 0, 0)
placeidd.BorderSizePixel = 0
placeidd.Position = UDim2.new(0.0365468338, 0, 0.424981147, 0)
placeidd.Size = UDim2.new(0, 223, 0, 16)
placeidd.ClearTextOnFocus = false
placeidd.Font = Enum.Font.SourceSans
placeidd.PlaceholderColor3 = Color3.fromRGB(223, 223, 223)
placeidd.PlaceholderText = "PlaceID (left empy for currect game)"
placeidd.Text = ""
placeidd.TextColor3 = Color3.fromRGB(255, 255, 255)
placeidd.TextSize = 14.000

-- smooth drag from sigma aim whata fu
	...
	if plcid == game.PlaceId then
		if queue_on_teleport then
			...
			local queue = string.format([[
				...
				game.StarterGui:SetCore("SendNotification", {
					Title = "Sigma",
					Text = "Teleported! Your server code saved to clipboard!! :3 \nor check ur console (F9 or /console)",
					Duration = 10,
					callback = bindableFunction,
				})
			]], accessCode)
