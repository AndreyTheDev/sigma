...
local WHATA = Instance.new("TextButton")
local U3ICorner = Instance.new("UICorner")

WHATA.Name = "WHATA"
WHATA.Parent = misc.misc
WHATA.BackgroundColor3 = bcolor
WHATA.BackgroundTransparency = 0.200
WHATA.BorderColor3 = Color3.fromRGB(0, 0, 0)
WHATA.BorderSizePixel = 0
WHATA.Position = UDim2.new(0.124, 0,4.85, 0)
WHATA.Size = UDim2.new(0, 115, 0, 18)
WHATA.Font = Enum.Font.Arial
WHATA.Text = "fakelag [BROKEN]"
WHATA.TextColor3 = Color3.fromRGB(255, 255, 255)
WHATA.TextSize = 14.000

U3ICorner.CornerRadius = UDim.new(0, 2)
U3ICorner.Parent = WHATA
...
WHATA.MouseButton1Click:Connect(function()
    print(111)
end)
...
local buttns = {
    ...
    {WHATA, "makes fake lags :3 [BROKEN]"}
}
